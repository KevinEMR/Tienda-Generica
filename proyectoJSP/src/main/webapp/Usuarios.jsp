...
<form action="Usuario_agregar.jsp" id ="agregar_usuario">
<button type="submit" class="btn btn-outline-light">Agregar Usuario</button>
</form>
<form id = "consultar_usuario" action="Usuarios.jsp">
<table>
<tr>
...
<table class="table table-hover">
  ...
  %>
    <tr>
      ...
      <td><a href = "Usuario_eliminar.jsp?cedula=<%= list.get(i).getCedula() %>">Eliminar</a></td>
    </tr>
    <%}}}
