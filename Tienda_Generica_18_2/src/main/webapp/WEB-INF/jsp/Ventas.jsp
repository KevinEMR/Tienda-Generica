...
<tbody>
<tr id = "fila3">
<td><label for="codigo_producto">C�digo:</label></td>
...
function matematicas(val,num){
	...
	function totales(num){
		...
		document.getElementById("Total_iva").value = sumaiva.toFixed(2);
