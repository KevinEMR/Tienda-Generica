...
<form id = "U_editar" action = "/Agregar_cliente_error" method = "post" >
		<div>
		<div id = "mensaje">
            ...
            <div class="mb-3 form-check">
                ...
                <input type="button" onclick="location.href='/Clientes';" class="btn btn-primary" name="Atrás" value="Atrás">
            </div>
        </div>
    </form>
    <%
